 ...
 *
 * This specific implementation relies on cuBLAS and is used for testing.
 *
 ...
 */
vector<vtype>* solve_cgs_cublas(handles* h, CSR* Alocal, vector<vtype>* rhs_loc, vector<vtype>* x_loc, Preconditioner* pr, const InputParameters& ip, const CurrentParameters& cp, SolverOut* out);
