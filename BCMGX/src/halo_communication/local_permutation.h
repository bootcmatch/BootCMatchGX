...
void apply_mask_permut_GPU(CSR* Alocal, vector<gsstype>* shrinking_permut, FILE* fp = stdout);
...
void reverse_mask_permut_GPU(CSR* Alocal, vector<gsstype>* shrinking_permut, FILE* fp = stdout);
